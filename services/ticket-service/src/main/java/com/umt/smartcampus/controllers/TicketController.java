...
public class TicketController {
    ...
    public List<TicketResponse> getAssignedTickets(HttpServletRequest request) {
        AuthenticatedUser authenticatedUser = requireAssigneeUser(request);
    ...
    public TicketResponse updateTicketStatus(
        ...
        AuthenticatedUser authenticatedUser = requireStatusUpdateAccess(ticketId, request);
    ...
    public TicketResponse updateTicketAssignee(
        ...
        AuthenticatedUser authenticatedUser = requireOperationsUser(request);
    ...
    public TicketResponse addTicketComment(
        ...
        AuthenticatedUser authenticatedUser = requireCommentAccess(ticketId, request);
    ...
    private AuthenticatedUser requireStatusUpdateAccess(Long ticketId, HttpServletRequest request) {
        AuthenticatedUser user = getAuthenticatedUser(request);
        Ticket ticket = findTicket(ticketId);
    ...
    private AuthenticatedUser requireCommentAccess(Long ticketId, HttpServletRequest request) {
    ...
    private AuthenticatedUser getAuthenticatedUser(HttpServletRequest request) {
        AuthenticatedUser user = getOptionalAuthenticatedUser(request);
        if (user == null) {
    ...
    private AuthenticatedUser getOptionalAuthenticatedUser(HttpServletRequest request) {
        return (AuthenticatedUser) request.getAttribute(AuthInterceptor.AUTHENTICATED_USER);
    }

    private String resolveRequesterName(Ticket ticket, AuthenticatedUser authenticatedUser) {
    ...
    private String resolveRequesterEmail(Ticket ticket, AuthenticatedUser authenticatedUser) {
        if (authenticatedUser != null) {
    ...
    private AuthenticatedUser requireAssigneeUser(HttpServletRequest request) {
        AuthenticatedUser user = getAuthenticatedUser(request);
    ...
    private boolean isAssignedToUser(Ticket ticket, AuthenticatedUser user) {
